...
?>
			...
			<div id="todaysay" class="grid_5 alpha prefix_1 BOX" >
				...
				<a href="#" >Said it!</a> 
				<a href="#" >Rate it!</a>
				<a href="#" onclick="ShareIt('todaysay_cont')"><img src="img/fb_share.gif" class="fbShareButton"alt="Share!" title="Share on Facebook" ></a>	
			...
			<div id="todaydo" class="grid_5 BOX" >
				...
				<a href="#" >Did it!</a>
				<a href="#" >Rate it!</a>
				<a href="#" onclick="ShareIt('todaydo_cont')"><img src="img/fb_share.gif" class="fbShareButton"alt="Share!" title="Share on Facebook" ></a>	
			...
			<div id="todaygive" class="grid_5 BOX" >
				...
				<a href="#" >Gave it!</a>
				<a href="#" >Rate it!</a>
				<a href="#" onclick="ShareIt('todaygive_cont')"><img src="img/fb_share.gif" class="fbShareButton"alt="Share!" title="Share on Facebook" ></a>	
			...
			*****************************************************************-->
			...
			<div id="biggersay" class="grid_5 alpha prefix_1 BOX" >
				...
				<a href="#" >Said it!</a>
				<a href="#" >Rate it!</a>
				<a href="#" onclick="ShareIt('biggersay_cont')"><img src="img/fb_share.gif" class="fbShareButton"alt="Share!" title="Share on Facebook" ></a>
			...
			<div id="biggerdo" class="grid_5 BOX" >
				...
				<a href="#" >Did it!</a>
				<a href="#" >Rate it!</a>
				<a href="#" onclick="ShareIt('biggerdo_cont')"><img src="img/fb_share.gif" class="fbShareButton"alt="Share!" title="Share on Facebook" ></a>	
			...
			<div id="biggergive" class="grid_5 BOX" >
				...
				<a href="#" >Gave it!</a>
				<a href="#" >Rate it!</a>
				<a href="#" onclick="ShareIt('biggergive_cont')"><img src="img/fb_share.gif" class="fbShareButton"alt="Share!" title="Share on Facebook" ></a>
			...
			*****************************************************************-->		
			...
			<div id="specialsay" class="grid_5 alpha prefix_1 BOX" title="A nice thing to say for a special occasion">
				...
				<a href="#" >Said it!</a>
				<a href="#" >Rate it!</a>
				<a href="#" onclick="ShareIt('specialsay_cont')"><img src="img/fb_share.gif" class="fbShareButton"class="fbShareButton" alt="Share!" title="Share on Facebook" ></a>
			...
			<div id="specialdo" class="grid_5 BOX" title="A nice thing to do for a special occasion">
				...
				<a href="#" >Did it!</a>
				<a href="#" >Rate it!</a>
				<a href="#" onclick="ShareIt('specialdo_cont')"><img src="img/fb_share.gif" class="fbShareButton"alt="Share!" title="Share on Facebook" ></a>	
			...
			<div id="specialgive" class="grid_5 BOX" title="A nice thing to give for a special occasion">
				...
				<a href="#" >Gave it!</a>
				<a href="#" >Rate it!</a>
				<a href="#" onclick="ShareIt('specialgive_cont')"><img src="img/fb_share.gif" class="fbShareButton"alt="Share!" title="Share on Facebook" ></a>
