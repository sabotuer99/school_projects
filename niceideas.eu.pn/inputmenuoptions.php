...
if($value=='bigger') {
	...
	echo '		<select id="biggertimeframe" onchange="ideapreview(&#39;biggertimeframe&#39;,&#39;timeframepreview&#39;);">';
...
if($value=='special') {
	...
	echo '		<select id="specialoccasion" onchange="ideapreview(&#39;specialoccation&#39;,&#39;specialpreview&#39;);">';
