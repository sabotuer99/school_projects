...
<!-- MAIN CONTENT AREA -->	
<body onload="<?php if (isset($_SESSION['navigate'])) {echo "navigate('".$_SESSION['navigate']."');";} ?>">
	<div id="fb-root"></div>
...
// load head section
 ...
 <div id="menuleft" class="grid_12">	
	...
	<nav>
		...
		<a href="#" id="profilelink" class="" onclick="navigate('profile.php','profilelink');">Your Profile</a>
	...
	<menu>
		...
		-->	
				...
				if(isset($_SESSION['FbId'])) 
					{
					echo "<img src='https://graph.facebook.com/".$_SESSION['FbId']."/picture'>";
					}
				?>
				</div>
				<img src="img/ajax-loader.gif" alt="loading" id="loader" />
				<button id="fb-auth" onclick="FB.getLoginStatus(updateButton);"><img src="img/icons/facebook.png" id="fbconnectimg"/></button>
