...
<div>
		...
		<input type="password" id="pswLogin" value="" onchange="hashPassword()" onkeyup="hashPassword()" />
</div> 
<div>
		<span>User:</span><br> 
        <input name="userLogin" type="text" id="userLogin" value="" onchange="hashPassword()" onkeyup="hashPassword()" />
</div>
