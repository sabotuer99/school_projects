...
document.getElementById(destination).innerHTML = selectdata;
...
*/
		...
		opt4menu.innerHTML =	'<select id="biggertimeframe" onchange="ideapreview(&#39;biggertimeframe&#39;,&#39;opt4preview&#39;);">'+
		...
		opt4menu.innerHTML =	'<select id="specialoccasion" onchange="ideapreview(&#39;specialoccasion&#39;,&#39;opt4preview&#39;);">'+
...
function hashPassword(pswSource,usrSource,hashDest) {
	var pass =	document.getElementById(pswSource).value;
	var user = document.getElementById(usrSource).value.toUpperCase();
	var Message = pass + user;
	var pwdhash = document.getElementById(hashDest);
	var hashedval = CryptoJS.SHA3(Message);
	pwdhash.setAttribute('value', hashedval);	
