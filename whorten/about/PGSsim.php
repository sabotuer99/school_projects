...
<div style="width:100%">
<img width="400px" style="margin-right:auto;margin-left:auto;display:block" src="/about/Fox_Drawing.jpg" alt="Student Submission" title="Work submitted by student">
</div>
<br>
<strong>Grade this submission with the following rubrics:</strong>
<div style="width:100%">
<table class="rubric_table rub2col" summary=""  style="width:100%" width="100%">
...
<table class="rubric_table rub2col" summary=""  style="width:100%" width="100%">
	<tr style="border-bottom:none">
		<td class="tableheader" style="border-bottom:none">
			Signed Work: The student clearly signed their work.
		</td>
		<td style="border-bottom:none">
			<button class="myButton" data-target="rubric4div" onclick="toggle_rubric_table(this)">Show</button>
		</td>
	</tr>
	<tr style="border-top:none">
		<td colspan="3" style="padding: 0px">
			<div class="rubinnerdiv" id="rubric4div" style="height:0px;">
				<table summary="" style="margin:0px;border-top:none;width:100%" class="rubinner">
					<tr class="tableheader" style="border-top:1px dotted">	
						<td>Description</td>
						<td width="65px">Grade</td>
					...
					<tr>
						<td>
							The work is clearly signed by the student
						</td>		
						<td>
					...
					<tr>
						<td>
							The work is not clearly signed by the student 
						</td>
						<td>
...
<table class="rubric_table rub3col" summary=""  style="width:100%" width="100%">	
	<tr style="border-bottom:none">
		<td colspan="2" class="tableheader" style="border-bottom:none">
			Subject & Focus: The submission should be a sketch of an woodland animal with no scenery. "Woodland creature" means a land based 
...
<table class="rubric_table rub3col" summary=""  style="width:100%" width="100%">	
	...
	<tr style="border-bottom:none">
		<td colspan="2" class="tableheader" style="border-bottom:none">
			Style & Effort: The submission is in a realistic style, and the student demonstrated persevered until the work was
			...
			<div class="rubinnerdiv"  id="rubric2div" style="height:0px;">
				<table summary="" style="margin: 0px;border-top:none;width:100%" class="rubinner">
					...
					<tr>
						...
						<td>
							<input type="radio" name="rubric4" value="10">  A+
							<input type="radio" name="rubric4" value="9">  A-
						</td>			
					</tr>
					...
					<tr>		
						...
						<td>
							<input type="radio" name="rubric4" value="8">  B+
							<input type="radio" name="rubric4" value="7">  B-
						</td>
					</tr>	
					...
					<tr>
						...
						<td>
							<input type="radio" name="rubric4" value="6">  C+
							<input type="radio" name="rubric4" value="5">  C-
						</td>			
					</tr>	
					...
					<tr >
						...
						<td>
							<input type="radio" name="rubric4" value="4">  D+
							<input type="radio" name="rubric4" value="3">  D-
						</td>				
					</tr>
					...
					<tr >
						...
						<td>
							<input type="radio" name="rubric4" value="2">  F+
							<input type="radio" name="rubric4" value="1">  F-
						</td>		
					</tr>	
				</table>
			</div>
...
<table class="rubric_table rub3col" summary=""  style="width:100%" width="100%">	
	<tr style="border-bottom:none">
		<td colspan="2" class="tableheader" style="border-bottom:none">
			Shadow & Contrast: Student makes effective use of light and shadow to give the subject depth.
		</td>
		<td style="border-bottom:none">
			<button class="myButton" data-target="rubric5div" onclick="toggle_rubric_table(this)">Show</button>
		</td>
	</tr>
	<tr style="border-top:none">
		<td colspan="3" style="padding: 0px">
			<div class="rubinnerdiv"  id="rubric5div" style="height:0px;">
				<table summary="" style="margin: 0px;border-top:none;width:100%" class="rubinner">
					<tr class="tableheader" style="border-top:1px dotted">
						<td>Description</td>
						<td>Examples</td>
					...
					<tr >
						<td >
							Significant contrast between light and dark areas of sketch. Student has created a highly effective illusion of depth.
						</td>		
						<td >
							<a href="http://fc04.deviantart.net/fs71/i/2011/343/b/7/rabbit_drawing__by_marx_man-d4im3xh.jpg" target="_blank" ><img width="45%" src="http://fc04.deviantart.net/fs71/i/2011/343/b/7/rabbit_drawing__by_marx_man-d4im3xh.jpg" alt="" ></a> 
						</td>			
						<td>
							<input type="radio" name="rubric5" value="10">  A+
							<input type="radio" name="rubric5" value="9">  A-
						</td>			
					</tr>
					
					<tr >
						<td >
							Commendable use contrast, but highlights and shadow could be lighter and darker, respectively.  
						</td>	
						<td >
							<a href="http://www.therabbithouse.com/blog/wp-content/uploads/2010/01/dutch_finished_blog.jpg" target="_blank" ><img width="45%" src="http://www.therabbithouse.com/blog/wp-content/uploads/2010/01/dutch_finished_blog.jpg" alt="" ></a> 
						</td>	
						<td>
							<input type="radio" name="rubric5" value="8">  B+
							<input type="radio" name="rubric5" value="7">  B-
						</td>
					</tr>	
				
					<tr >
						<td >
				 			The student used an average amount of contrast; adequate, but not as good as it could have been, a bit careless.
						</td>	
						<td >
							<a href="http://fc01.deviantart.net/fs70/f/2012/330/f/b/rabbit_drawing_by_dragonscarf-d5m7vsp.png" target="_blank" ><img width="45%" src="http://fc01.deviantart.net/fs70/f/2012/330/f/b/rabbit_drawing_by_dragonscarf-d5m7vsp.png" alt="" ></a> 
						</td>			
						<td >
							<input type="radio" name="rubric5" value="6">  C+
							<input type="radio" name="rubric5" value="5">  C-
						</td>			
					</tr>	
				
					<tr >
						<td >
							The use of contrast is barely perceptible. The student made little effort to create shadows or highlights. 
							The whole drawing is either very light or very dark.
						</td>	
						<td >
							<a href="http://fc03.deviantart.net/fs70/f/2012/009/7/4/pencil_drawing__rabbit_by_minhaaako-d4lvmq4.jpg" target="_blank" ><img width="45%" src="http://fc03.deviantart.net/fs70/f/2012/009/7/4/pencil_drawing__rabbit_by_minhaaako-d4lvmq4.jpg" alt="" ></a>  
				 		</td>			
						<td>
							<input type="radio" name="rubric5" value="4">  D+
							<input type="radio" name="rubric5" value="3">  D-
						</td>				
					</tr>
						
					<tr >
						<td >
							The drawing is a basic outline and shows no contrast whatsoever. The student clearly made no 
							effort to use light and shadow effectively. 
						</td>
						<td >
							<a href="http://0.tqn.com/d/drawsketch/1/0/t/N/rabbit4.jpg" target="_blank" ><img width="45%" src="http://0.tqn.com/d/drawsketch/1/0/t/N/rabbit4.jpg" alt="" ></a> 
						</td>		
						<td>
							<input type="radio" name="rubric5" value="2">  F+
							<input type="radio" name="rubric5" value="1">  F-
						</td>		
					</tr>		
				</table>
			</div>
...
<span>Your Name: </span><input type="text" id="visitorname" value="<?php echo 'Guest_'.substr(md5(rand()), 0, 9); ?>">
<button class="myButton" data-subID="sim" onclick="submit_rubrics(this)">Submit Marks</button>
<div id="marksubresult"></div>
<?php 
?>