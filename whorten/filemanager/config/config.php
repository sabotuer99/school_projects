...
{
	$docroot = $_SERVER['DOCUMENT_ROOT'].'/whorten';	
}


$root = rtrim($docroot,'/'); /* don't touch this parameter */
$base_url="";  /* base url of site (without final /). If you prefer relative urls leave empty  */
$upload_dir = $_SESSION['upload_dir'];/*'/source/'; /* path from base_url to base of upload folder (with start and final /) */
$current_path = $_SESSION['current_path'];/*'../source/'; /* relative path from filemanager folder to upload folder (with final /) */

/*thumbs folder can't put inside upload folder  **/
$thumbs_base_path = $_SESSION['thumbs_base_path']; // relative path from filemanager folder to thumbs folder (with final /)


/*
$root = $_SERVER['DOCUMENT_ROOT']; /* don't touch this parameter 
$base_url="";  /* base url of site (without final /). If you prefer relative urls leave empty  
